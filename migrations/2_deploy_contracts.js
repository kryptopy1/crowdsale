...
// module.exports = async function(deployer, network, accounts) {
    ...
    console.log(_listOfOwners, _minRequired);
    await deployer.deploy(
      MultiSigWallet,
      _listOfOwners,
      _minRequired
    ...
    // Deploy the Early Token Sale
    console.log(_startTime, _endTime, _rate, _goal, _cap, MultiSigWallet.address);
    await deployer.deploy(
      KryptopyCrowdsale,
      _startTime,
      _endTime,
    ...
    //   return await KryptopyCrowdsale.new(_startBlock, _endBlock, _rate, _goal, _cap, multisigWalletInstance.address);
    //
    // }).then(async function(Instance) {
    //
    //   crowdsaleInstance = Instance;
    //   if (debug) console.log(_startBlock, _endBlock, _rate, _goal, _cap, multisigWalletInstance.address);
